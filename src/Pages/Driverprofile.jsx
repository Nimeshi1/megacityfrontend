  ...
  useEffect(() => {
    const fetchDriverData = async () => {
      try {
        ...
        await fetchBookings(driverId); // Pass driverId to fetchBookings
        setIsLoading(false);
      } catch (err) {
  ...
  const fetchBookings = async (driverId) => {
    try {
      ...
      if (response.status === 200) {
        ...
        // Add passenger names if not included
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        {/* <div className="flex items-center">
                          ...
                          <span className="ml-2 text-gray-300">({(driver.rating || 5).toFixed(1)})</span>
                        </div> */}
